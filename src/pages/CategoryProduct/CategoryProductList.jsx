...
import { ADMIN_FOLDER, API_ENDPOINT, NOTI_CONFIRMED_DELETE, NOTI_DELETE_FAIL, NOTI_DELETE_SUCCESSFULLY, NOTI_TYPE_DANGER, NOTI_TYPE_SUCCESS, NOTI_TYPE_WARNING, TIME_OUT } from "configs";
...
function CategoryProductList() {
  ...
  function handleDelete(id) {
    ...
    if (confirmed) {
      ...
      axios({
        method: "DELETE",
        url: `${API_ENDPOINT}/category-product/${id}`,
        timeout: TIME_OUT,
      })
        .then((res) => {
        ...
        return (
          <tr key={idx}>
            ...
            <td className="border-b border-r p-2 text-center">
              <Link to={`/${ADMIN_FOLDER}/category-product/${item.id}`} className="border-0 bg-transparent">
